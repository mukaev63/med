...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button style="margin-top: 10px;" class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Мои пациенты</button>
        <button style="margin-top: 10px;" class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Добавить нового пациента</button>
    </div>
</nav>
        ...
        <?php foreach ($posts as $key => $post): ?>
                <div class="card" style="width: 18rem; margin: 10px 0;margin-right: 50px; padding: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="editUsersCard.php?id=<?=$post['card_id'];?>" class="btn btn-primary" style="margin-right: 10px;">Редактировать</a>
                        <a href="editUsersCard.php?delete_id=<?=$post['card_id'];?>" class="btn btn-primary">Удалить</a>
                        </div>
                    </div>
                </div>
        <?php endforeach; ?>
